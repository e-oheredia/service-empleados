...
public class BuzonController {
	...
	@GetMapping()
	public ResponseEntity<Iterable<Buzon>> listarByIds(@RequestParam ){
		return new ResponseEntity<Iterable<Buzon>>(buzonService.listarByIds(List<Long> idsids), HttpStatus.OK);
	}
